...
(function(){
	...
	var permutation = [
		...
		130,116,188,159,86,164,100,109,198,173,186, 3,64,52,217,226,250,124,123, 5,202,38,
		147,118,126,255,82,85,212,207,206,59,227,47,16,58,17,182,189,28,42, 223,183,170,
		213,119,248,152, 2,44,154,163, 70,221,153,101,155,167, 43,172,9, 129,22,39,253, 
		19,98,108,110,79,113,224,232,178,185, 112,104,218,246,97,228, 251,34,242,193,238, 
	...
	noise = function(x, y, z, octaves, persistence) {

		if(_.isUndefined(y)){y = x + 1000.2;}
		if(_.isUndefined(z)){z = x + 2000.6;}
		if(_.isUndefined(octaves)){octaves = 2;}
		if(_.isUndefined(persistence)){persistence = 1;}
		...
		for(var i=0; i < octaves; i++) {
			total += noise2(x * frequency, y * frequency, z * frequency) * amplitude;
